...
namespace ManagedCorDebug
{
    ...
    public class CorDebugUnmanagedCallback : ICorDebugUnmanagedCallback
    {
        ...
        HRESULT ICorDebugUnmanagedCallback.DebugEvent(IntPtr pDebugEvent, int fOutOfBand) => HandleEvent(OnDebugEvent, new DebugEventCorDebugUnmanagedCallbackEventArgs(pDebugEvent, fOutOfBand));
