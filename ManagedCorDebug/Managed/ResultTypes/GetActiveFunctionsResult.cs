...
namespace ManagedCorDebug
{
    ...
    {
        /// <summary>
        /// A pointer to the number of objects returned in the pFunctions array. The number of objects returned will be equal to the number of managed frames on the stack.
        /// </summary>
        public int pcFunctions { get; }

        /// <summary>
        /// An array of <see cref="COR_ACTIVE_FUNCTION"/> objects, each of which contains information about the active functions in this thread's frames.<para/>
