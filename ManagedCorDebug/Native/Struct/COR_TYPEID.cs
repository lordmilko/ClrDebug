...
namespace ManagedCorDebug
{
    ...
    /// </summary>
    /// <remarks>
    /// The COR_TYPEID structure is returned by a number of debugging methods that provide information about objects to
    ...
    /// COR_TYPEID value from the COR_HEAPOBJECT.type field to the <see cref="ICorDebugProcess5.GetTypeForTypeID"/> method
    /// to retrieve an ICorDebugType object that provides type information about the object. A COR_TYPEID object is intended
