...
namespace ManagedCorDebug
{
    ...
    {
        /// <summary>
        /// The object on which the thread is blocking. This object is valid only for the duration of the current synchronized state. If two threads are blocking on the same object within the same synchronized state, you may expect the <see cref="ICorDebugValue.GetAddress"/> method to return the same value. However, the interfaces may or may not be pointer equivalent.
        /// </summary>
