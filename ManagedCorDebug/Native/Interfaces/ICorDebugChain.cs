...
namespace ManagedCorDebug
{
    ...
    /// either managed or unmanaged code chains. An empty ICorDebugChain instance represents an unmanaged code chain.
    /// </remarks>
    ...
    public interface ICorDebugChain
    {
        ...
        /// </summary>
        /// <param name="ppThread">[out] A pointer to an ICorDebugThread object that represents the physical thread this call chain is part of.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="pStart">[out] A pointer to a CORDB_ADDRESS value that is the starting address of the stack segment.</param>
        /// <param name="pEnd">[out] A pointer to a CORDB_ADDRESS value that is the ending address of the stack segment.</param>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="ppChain">[out] A pointer to the address of an ICorDebugChain object that represents the called chain. If this chain is currently executing (that is, if this chain is not waiting for a called chain to return), ppChain will be null.</param>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="ppFrames">[out] A pointer to the address of an ICorDebugFrameEnum object that is the enumerator for the stack frames.</param>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="ppFrame">[out] A pointer to the address of an ICorDebugFrame object that represents the active (that is, most recent) frame on the chain.</param>
        /// <remarks>
        ...
        /// and for some chains initiated due to CHAIN_CLASS_INIT. See the CorDebugChainReason enumeration.
        /// </remarks>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        /// </summary>
        /// <param name="pReason">[out] A pointer to a value (a bitwise combination) of the CorDebugChainReason enumeration that indicates the reason for the genesis of this calling chain.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
