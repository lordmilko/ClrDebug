...
namespace ManagedCorDebug
{
    ...
    public interface ISymUnmanagedAsyncMethodPropertiesWriter
    {
        ...
        /// <summary>
        /// Sets the IL offset for the compiler-generated catch handler that wraps an async method.<para/>
        ...
        /// <summary>
        /// Define a group of async await operations in the current method.<para/>
