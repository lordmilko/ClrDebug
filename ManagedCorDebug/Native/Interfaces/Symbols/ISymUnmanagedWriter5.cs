...
namespace ManagedCorDebug
{
    ...
    public interface ISymUnmanagedWriter5 : ISymUnmanagedWriter4
    {
        ...
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        new HRESULT OpenNamespace([In] string name);
        ...
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        new HRESULT UsingNamespace([In] string fullName);
        ...
        new HRESULT GetDebugInfo(
            [In, Out] ref long pIDD, [In] int cData, out int pcData, [MarshalAs(UnmanagedType.LPArray), Out] byte[] data);
