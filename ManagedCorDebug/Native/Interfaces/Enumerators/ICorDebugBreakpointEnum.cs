...
namespace ManagedCorDebug
{
    ...
    public interface ICorDebugBreakpointEnum : ICorDebugEnum
    {
        ...
        /// </summary>
        /// <param name="celt">[in] The number of ICorDebugBreakpoint instances to be retrieved.</param>
        /// <param name="breakpoints">[out] An array of pointers, each of which points to an ICorDebugBreakpoint object that represents a breakpoint.</param>
        /// <param name="pceltFetched">[out] A pointer to the number of ICorDebugBreakpoint instances actually returned. This value may be null if celt is one.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        HRESULT Next([In] uint celt, [MarshalAs(UnmanagedType.Interface), Out] out ICorDebugBreakpoint breakpoints, out uint pceltFetched);
    }
}