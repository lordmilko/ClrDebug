...
namespace ManagedCorDebug
{
    ...
    public interface ICorDebugAppDomain2
    {
        ...
        /// </summary>
        /// <param name="elementType">[in] A value of the CorElementType enumeration that specifies the underlying native type (an array, pointer, or reference) to be created.</param>
        ...
        /// <param name="pTypeArg">[in] A pointer to an ICorDebugType object that represents the type of array, pointer, or reference to be created.</param>
        /// <param name="ppType">[out] A pointer to the address of an ICorDebugType object that represents the constructed array, pointer type, or reference type.</param>
        /// <remarks>
