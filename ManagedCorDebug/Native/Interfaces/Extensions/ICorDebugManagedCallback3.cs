...
namespace ManagedCorDebug
{
    ...
    public interface ICorDebugManagedCallback3
    {
        ...
        /// thread object that was passed to the System.Diagnostics.Debugger.NotifyOfCrossThreadDependency method. The thread
        /// object's type must have been previously enabled by calling the <see cref="ICorDebugProcess3.SetEnableCustomNotification"/>
