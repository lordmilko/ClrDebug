...
namespace ManagedCorDebug
{
    ...
    public interface ICorDebugArrayValue : ICorDebugHeapValue
    {
        ...
        /// </summary>
        /// <param name="pType">[out] A pointer to a value of the CorElementType enumeration that indicates the type.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        /// </summary>
        /// <param name="pnRank">[out] A pointer to the number of dimensions in this ICorDebugArrayValue object.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        /// </summary>
        /// <param name="pbHasBaseIndicies">[out] A pointer to a Boolean value that is true if one or more dimensions of this ICorDebugArrayValue object have a base index of non-zero; otherwise, the Boolean value is false.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        /// </summary>
        /// <param name="cdim">[in] The number of dimensions of this ICorDebugArrayValue object. This value is also the size of the indicies array because its size is equal to the number of dimensions of the ICorDebugArrayValue object.</param>
        /// <param name="indicies">[out] An array of integers, each of which is the base index (that is, the starting index) of a dimension of this ICorDebugArrayValue object.</param>
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        /// <param name="ppValue">[out] A pointer to the address of an ICorDebugValue object that represents the value of the element.</param>
        /// <remarks>
