...
namespace ManagedCorDebug
{
    ...
    public interface ICorDebugHeapValue2
    {
        ...
        /// </summary>
        /// <param name="type">[in] A value of the CorDebugHandleType enumeration that specifies the type of handle to be created.</param>
        /// <param name="ppHandle">[out] A pointer to the address of an ICorDebugHandleValue object that represents the new handle for this heap value.</param>
        /// <remarks>
