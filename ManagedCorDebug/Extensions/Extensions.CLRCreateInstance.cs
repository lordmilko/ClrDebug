...
using static ManagedCorDebug.NativeMethods;
...
namespace ManagedCorDebug
{
    ...
    public static partial class Extensions
    {
        ...
        public class CLRCreateInstanceInterfaces
        {
            ...
            /// <summary>
            /// Provides the <see cref="ManagedCorDebug.CLRMetaHostPolicy.GetRequestedRuntime"/> method, which returns a pointer to a common language runtime (CLR) interface based on a policy criteria, managed assembly, version and configuration file.
            /// </summary>
