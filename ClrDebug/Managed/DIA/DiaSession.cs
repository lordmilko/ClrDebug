namespace ClrDebug.DIA
{
    ...
    public class DiaSession : ComObject<IDiaSession>
    {
        ...
        /// Retrieves a reference to the global scope.
        /// </summary>
        /// <param name="pRetValResult">[out] Returns an IDiaSymbol object that represents the global scope.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// Retrieves an enumerator for all tables contained in the symbol store.
        /// </summary>
        /// <param name="ppEnumTablesResult">[out] Returns an IDiaEnumTables object. Use this interface to enumerate the tables in the symbol store.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// Retrieves an enumerator that finds symbols in the order of their addresses.
        /// </summary>
        /// <param name="ppEnumbyAddrResult">[out] Returns an IDiaEnumSymbolsByAddr object. Use this interface to search for symbols in the symbol store by memory location.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// Retrieves an enumerated sequence of debug data streams.
        /// </summary>
        /// <param name="ppEnumDebugStreamsResult">[out] Returns an IDiaEnumDebugStreams object that contains a list of debug streams.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaEnumSymbols object that contains the list of child symbols retrieved.</returns>
        ...
        /// <param name="name">[in] Specifies the name of the children to be retrieved. Set to NULL for all children to be retrieved.</param>
        /// <param name="compareFlags">[in] Specifies the comparison options applied to name matching. Values from the NameSearchOptions Enumeration enumeration can be used alone or in combination.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumSymbols object that contains the list of child symbols retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaSymbol object that represents the symbol retrieved.</returns>
        ...
        /// <param name="offset">[in] Specifies the offset component of the address.</param>
        /// <param name="symTag">[in] Symbol type to be found. Values are taken from the SymTagEnum Enumeration enumeration.</param>
        /// <param name="ppSymbolResult">[out] Returns an IDiaSymbol object that represents the symbol retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaEnumSourceFiles object that contains a list of the source files retrieved.</returns>
        ...
        /// <param name="name">[in] Specifies the name of the source file to be retrieved. Set this parameter to NULL for all source files to be retrieved.</param>
        /// <param name="compareFlags">[in] Specifies the comparison options applied to name searching. Values from the NameSearchOptions Enumeration enumeration can be used alone or in combination.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumSourceFiles object that contains a list of the source files retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaSourceFile object that represents the source file retrieved.</returns>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="uniqueId">[in] Specifies the source file identifier.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaSourceFile object that represents the source file retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        /// <remarks>
        /// The source file identifier is a unique value used internally to the DIA SDK to make all source files unique. This
        /// method is typically used internally to the DIA SDK.
        ...
        /// <returns>[out] Returns an IDiaEnumLineNumbers object that contains a list of the line numbers retrieved.</returns>
        ...
        /// <param name="compiland">[in]An IDiaSymbol object representing the compiland. Use this interface as a context in which to search for the line numbers.</param>
        /// <param name="file">[in] An IDiaSourceFile object representing the source file in which to search for the line numbers.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumLineNumbers object that contains a list of the line numbers retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaEnumLineNumbers object that contains a list of all the line numbers that cover the specified address range.</returns>
        ...
        /// <param name="offset">[in] Specifies the offset component of the specific address.</param>
        /// <param name="length">[in] Specifies the number of bytes of address range to cover with this query.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumLineNumbers object that contains a list of all the line numbers that cover the specified address range.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaEnumLineNumbers objta that contains a list of the line numbers retrieved.</returns>
        ...
        /// <param name="linenum">[in] Specifies a one-based line number.</param>
        /// <param name="column">[in] Specifies the column number. Use zero to specify all columns. A column is a byte offset into a line.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumLineNumbers objta that contains a list of the line numbers retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <returns>[out] Returns an IDiaEnumInjectedSources object that contains a list of all of the injected sources.</returns>
        ...
        /// </summary>
        /// <param name="srcFile">[in] Name of the source file for which to search.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumInjectedSources object that contains a list of all of the injected sources.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// <param name="linenum">[in] Specifies a one-based line number.</param>
        /// <param name="column">[in] Specifies the column number. Use zero to specify all columns. A column is a byte offset into a line.</param>
        /// <returns>[out] Returns an IDiaEnumLineNumbers object that contains a list of the line numbers that were retrieved.</returns>
        ...
        /// <param name="linenum">[in] Specifies a one-based line number.</param>
        /// <param name="column">[in] Specifies the column number. Use zero to specify all columns. A column is a byte offset into a line.</param>
        /// <param name="ppResultResult">[out] Returns an IDiaEnumLineNumbers object that contains a list of the line numbers that were retrieved.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
