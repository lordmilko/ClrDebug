...
namespace ClrDebug.DIA
{
    ...
    /// cref="Count"/> and <see cref="Item"/> methods. The interpretation of the IUnknown interface returned from either
    ...
    /// the <see cref="DiaEnumTables.Item"/> or <see cref="DiaEnumTables.MoveNext"/> methods. The following interfaces are
    ...
    public class DiaTable : EnumUnknown
    {
        ...
        /// </summary>
        /// <param name="index">[in] The index of the table entry in the range 0 to count-1, where count is returned by the <see cref="Count"/>property.</param>
