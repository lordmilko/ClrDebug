...
namespace ClrDebug.DbgEng
{
    ...
    public struct GetNumberEventFiltersResult
    {
        ...
        /// </summary>
        public uint SpecificEvents { get; }
        ...
        /// </summary>
        public uint SpecificExceptions { get; }
        ...
        /// </summary>
        public uint ArbitraryExceptions { get; }

        public GetNumberEventFiltersResult(uint specificEvents, uint specificExceptions, uint arbitraryExceptions)
        {
