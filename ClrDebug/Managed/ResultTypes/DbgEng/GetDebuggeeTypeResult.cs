...
{
    /// <summary>
    /// Encapsulates the results of the <see cref="DebugControl.DebuggeeType"/> property.
    /// </summary>
    [DebuggerDisplay("Class = {Class.ToString(),nq}, Qualifier = {Qualifier.ToString(),nq}")]
    public struct GetDebuggeeTypeResult
    {
        /// <summary>
        ...
        public GetDebuggeeTypeResult(DEBUG_CLASS @class, DEBUG_CLASS_QUALIFIER qualifier)
        {
            Class = @class;
            Qualifier = qualifier;
        }
