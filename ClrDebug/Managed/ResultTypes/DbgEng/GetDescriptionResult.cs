...
{
    /// <summary>
    /// Encapsulates the results of the <see cref="DebugRegisters.GetDescription"/> method.
    /// </summary>
    [DebuggerDisplay("NameBuffer = {NameBuffer}, Desc = {Desc.ToString(),nq}")]
    public struct GetDescriptionResult
    {
        /// <summary>
        ...
        public GetDescriptionResult(string nameBuffer, DEBUG_REGISTER_DESCRIPTION desc)
        {
