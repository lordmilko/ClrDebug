...
{
    /// <summary>
    /// Encapsulates the results of the <see cref="DebugSymbols.FindSourceFile"/> method.
    /// </summary>
    [DebuggerDisplay("FoundElement = {FoundElement}, Buffer = {Buffer}")]
    public struct FindSourceFileResult
    {
        /// <summary>
        ...
        public FindSourceFileResult(uint foundElement, string buffer)
        {
