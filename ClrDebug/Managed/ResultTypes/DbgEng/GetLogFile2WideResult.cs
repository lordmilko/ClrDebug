...
{
    /// <summary>
    /// Encapsulates the results of the <see cref="DebugControl.LogFile2Wide"/> property.
    /// </summary>
    [DebuggerDisplay("Buffer = {Buffer}, Flags = {Flags.ToString(),nq}")]
    public struct GetLogFile2WideResult
    {
        /// <summary>
        ...
        public GetLogFile2WideResult(string buffer, DEBUG_LOG flags)
        {
            Buffer = buffer;
            Flags = flags;
        }
