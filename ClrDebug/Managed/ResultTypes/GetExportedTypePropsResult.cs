...
namespace ClrDebug
{
    ...
    /// </summary>
    [DebuggerDisplay("szName = {szName}, ptkImplementation = {ptkImplementation.ToString(),nq}, ptkTypeDef = {ptkTypeDef.ToString(),nq}, pdwExportedTypeFlags = {pdwExportedTypeFlags.ToString(),nq}")]
    public struct GetExportedTypePropsResult
    {
        ...
        public GetExportedTypePropsResult(string szName, mdToken ptkImplementation, mdTypeDef ptkTypeDef, CorTypeAttr pdwExportedTypeFlags)
        {
            this.szName = szName;
