namespace ClrDebug.DbgEng
{
    ...
    /// </summary>
    public class DataModelConcept : ComObject<IDataModelConcept>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataModelConcept"/> class.
        /// </summary>
        /// <param name="raw">The raw COM interface that should be contained in this object.</param>
        public DataModelConcept(IDataModelConcept raw) : base(raw)
        {
        }

        #region IDataModelConcept
        #region Name
        ...
        public string Name
        {
            ...
            {
                string modelName;
                TryGetName(out modelName).ThrowDbgEngNotOK();
        ...
        public HRESULT TryGetName(out string modelName)
        {
            /*HRESULT GetName(
            [Out, MarshalAs(UnmanagedType.BStr)] out string modelName);*/
            return Raw.GetName(out modelName);
        }
        ...
        /// </remarks>
        public void InitializeObject(IModelObject modelObject, IDebugHostTypeSignature matchingTypeSignature, IDebugHostSymbolEnumerator wildcardMatches)
        {
            TryInitializeObject(modelObject, matchingTypeSignature, wildcardMatches).ThrowDbgEngNotOK();
        }
        ...
        /// prefill and preinitialize requisite caches. Implementation Example Note that a client will never call this interface.
        /// </remarks>
        public HRESULT TryInitializeObject(IModelObject modelObject, IDebugHostTypeSignature matchingTypeSignature, IDebugHostSymbolEnumerator wildcardMatches)
        {
            ...
            return Raw.InitializeObject(modelObject, matchingTypeSignature, wildcardMatches);
        }
