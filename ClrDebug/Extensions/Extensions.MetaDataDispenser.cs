...
namespace ClrDebug
{
    ...
    public static partial class Extensions
    {
        ...
        public static unsafe T DefineScope<T>(this MetaDataDispenser metaDataDispenser)
        {
            T ppIUnk;
        ...
        /// <returns>The pointer to the returned interface.</returns>
        public static unsafe T DefineScope<T>(this MetaDataDispenser metaDataDispenser, Guid rclsid, int dwCreateFlags)
        {
            T ppIUnk;
        ...
        /// <returns>A HRESULT that indicates success or failure.</returns>
        public static unsafe HRESULT TryGetOption<T>(this MetaDataDispenserEx metaDataDispenser, Guid optionId, out T value)
        {
