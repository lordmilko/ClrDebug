...
namespace ClrDebug
{
    public static partial class Extensions
    {
        ...
        public static unsafe T ReadMemory<T>(this CorDebugProcess process, CORDB_ADDRESS address) where T : unmanaged
        {
            T value;
        ...
        public static unsafe HRESULT TryReadMemory<T>(this CorDebugProcess process, CORDB_ADDRESS address, out T value) where T : unmanaged
        {
            var size = sizeof(T);
        ...
        /// if used improperly.
        /// </remarks>
        public static unsafe int WriteMemory<T>(this CorDebugProcess process, CORDB_ADDRESS address, T value) where T : unmanaged
        {
            int written;
        ...
        /// if used improperly.
        /// </remarks>
        public static unsafe HRESULT TryWriteMemory<T>(this CorDebugProcess process, CORDB_ADDRESS address, T value, out int written) where T : unmanaged
        {
            var size = sizeof(T);
            var buffer = Marshal.AllocHGlobal(size);
        ...
        public static unsafe T GetThreadContext<T>(this CorDebugProcess process, int threadId, ContextFlags contextFlags) where T : unmanaged
        {
            T context;
        ...
        /// <returns>A HRESULT that indicates success or failure.</returns>
        public static unsafe HRESULT TryGetThreadContext<T>(this CorDebugProcess process, int threadId, ContextFlags contextFlags, out T context) where T : unmanaged
        {
            var size = sizeof(T);
        ...
        public static unsafe void SetThreadContext<T>(this CorDebugProcess process, int threadId, T context) where T : unmanaged
        {
        ...
        /// <param name="context">The context to set. The context specifies the architecture of the processor on which the thread is executing.</param>
        /// <returns>A HRESULT that indicates success or failure.</returns>
        public static unsafe HRESULT TrySetThreadContext<T>(this CorDebugProcess process, int threadId, T context) where T : unmanaged
        {
            var size = sizeof(T);
            var buffer = Marshal.AllocHGlobal(size);
