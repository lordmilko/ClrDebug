...
namespace ClrDebug
{
    ...
    /// </summary>
    [DebuggerDisplay("usMajorVersion = {usMajorVersion}, usMinorVersion = {usMinorVersion}, usBuildNumber = {usBuildNumber}, usRevisionNumber = {usRevisionNumber}, szLocale = {szLocale.ToString(),nq}, cbLocale = {cbLocale}, rProcessor = {rProcessor.ToString(),nq}, ulProcessor = {ulProcessor}, rOS = {rOS.ToString(),nq}, ulOS = {ulOS}")]
