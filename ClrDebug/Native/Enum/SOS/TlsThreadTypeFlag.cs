...
{
    /// <summary>
    /// Flag used for thread type in Tls data.
    /// </summary>
    [Flags]
    public enum TlsThreadTypeFlag
    {
        ...
        /// <summary>
        /// Used to indicate that the thread is determining if a generic instantiation in an ngen image matches a lookup.
        /// </summary>
        ThreadType_GenericInstantiationCompare = 0x00020000
    }
}
