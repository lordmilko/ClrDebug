namespace ClrDebug.DbgEng
{
    ...
    {
        /// <summary>
        /// Returns the total number of processors and the number of the current
        /// processor referenced by a <see cref="PROCESSORINFO"/> structure.<para/>
        /// This ioctl is equivalent to the wdbgexts GetKdContext() function. Return value: <see langword="bool"/>.
        /// </summary>
        KD_CONTEXT = 1,
        ...
        //Return value: <see langword="bool"/>.
        IS_PTR64 = 19,
        GET_BUS_DATA = 20,
        SET_BUS_DATA = 21,

        /// <summary>
        /// Provides information about the type of a symbol. This ioctl should be used in conjunction
        /// with a <see cref="SYM_DUMP_PARAM"/> structure. Return value: <see cref="IoctlDumpError"/>.
        /// </summary>
        DUMP_SYMBOL_INFO = 22,
        LOWMEM_CHECK = 23,
        SEARCH_MEMORY = 24,
        ...
        //Return value: size of type if successful, otherwise 0.
        GET_TYPE_SIZE = 27,
