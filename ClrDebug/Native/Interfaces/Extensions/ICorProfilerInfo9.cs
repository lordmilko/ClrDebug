...
{
    /// <summary>
    /// A subclass of <see cref="ICorProfilerInfo8"/> that provides methods to query information about functions with multiple native code versions.
    /// </summary>
...
#endif
    public partial interface ICorProfilerInfo9 : ICorProfilerInfo8
    {
#if !GENERATED_MARSHALLING
        /// <summary>
