...
{
    /// <summary>
    /// [Supported in the .NET Framework 4.5.2 and later versions] A subclass of <see cref="ICorProfilerInfo4"/> that provides methods for use by code profilers to communicate with the common language runtime (CLR) to control event monitoring.
    /// </summary>
    /// <remarks>
    /// The methods available on this interface are intended to replace the <see cref="ICorProfilerInfo.GetEventMask"/>
    /// and <see cref="ICorProfilerInfo.SetEventMask"/> methods.
    /// </remarks>
...
#endif
    public partial interface ICorProfilerInfo5 : ICorProfilerInfo4
    {
#if !GENERATED_MARSHALLING
        /// <summary>
