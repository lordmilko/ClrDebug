...
{
    /// <summary>
    /// [Supported in the .NET Framework 4.7 and later versions] A subclass of <see cref="ICorProfilerCallback7"/> that provides callback methods used by the common language runtime to notify the profiler that JIT compilation of a dynamic method has started and finished.
    /// </summary>
...
#endif
    public partial interface ICorProfilerCallback8 : ICorProfilerCallback7
    {
#if !GENERATED_MARSHALLING
        /// <summary>
