...
{
    /// <summary>
    /// Supplements information to help a profiler identify the full closure of live objects, when used with either the <see cref="ICorProfilerCallback.RootReferences"/> or <see cref="ICorProfilerCallback2.RootReferences2"/> method together with the <see cref="ICorProfilerCallback.ObjectReferences"/> and <see cref="ConditionalWeakTableElementReferences"/> methods.<para/>
...
#endif
    public partial interface ICorProfilerCallback5 : ICorProfilerCallback4
    {
#if !GENERATED_MARSHALLING
        /// <summary>
