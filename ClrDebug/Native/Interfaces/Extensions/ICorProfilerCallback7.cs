...
{
    /// <summary>
    /// [Supported in the .NET Framework 4.6.1 and later versions] A subclass of <see cref="ICorProfilerCallback6"/> that provides a callback method that the common language runtime uses to notify the profiler that the symbol stream associated with an in-memory module is updated.
    /// </summary>
...
#endif
    public partial interface ICorProfilerCallback7 : ICorProfilerCallback6
    {
#if !GENERATED_MARSHALLING
        /// <summary>
