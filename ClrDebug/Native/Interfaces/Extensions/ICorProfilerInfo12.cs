...
{
    /// <summary>
    /// A subclass of <see cref="ICorProfilerInfo11"/> that provides methods to create EventPipe sessions, events, and providers.
    /// </summary>
...
#endif
    public partial interface ICorProfilerInfo12 : ICorProfilerInfo11
    {
#if !GENERATED_MARSHALLING
        /// <summary>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT EnumerateObjectReferences(
            [In] ObjectID objectId,
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetLOHObjectSizeThreshold(
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT RequestReJITWithInliners(
        ...
        /// <param name="cchValue">[in] The length, in characters, of szValue.</param>
        /// <param name="pcchValue">[out] A pointer to the total character length of szValue.</param>
        /// <param name="szValue">[out] A caller provided wide character buffer. When the function returns the buffer will contain the value of the environment variable.</param>
        [PreserveSig]
        new HRESULT GetEnvironmentVariable(
        ...
        /// <param name="cchName">[in] The size, in characters, of providerName.</param>
        /// <param name="pcchName">[out] A pointer to the total character length of providerName.</param>
        /// <param name="providerName">[out] A caller provided wide character buffer. When the function returns the buffer will contain the name of the provider.</param>
        [PreserveSig]
