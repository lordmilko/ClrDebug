...
{
    /// <summary>
    /// [Supported in the .NET Framework 4.5.2 and later versions] A subclass of <see cref="ICorProfilerCallback5"/> that provides a callback method that the common language runtime uses to notify a profiler that an assembly is loading.
    /// </summary>
...
#endif
    public partial interface ICorProfilerCallback6 : ICorProfilerCallback5
    {
#if !GENERATED_MARSHALLING
        /// <summary>
