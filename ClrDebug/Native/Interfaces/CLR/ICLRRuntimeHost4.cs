...
namespace ClrDebug
{
    //There does not appear to be an ICLRRuntimeHost3; ICLRRuntimeHost4 derives from ICLRRuntimeHost2
...
#endif
    public partial interface ICLRRuntimeHost4 : ICLRRuntimeHost2
    {
#if !GENERATED_MARSHALLING
        /// <summary>
        ...
        [PreserveSig]
        new HRESULT CreateAppDomainWithManager(
        ...
        [PreserveSig]
        new HRESULT Authenticate(
            [In] long authKey);

        [PreserveSig]
        new HRESULT RegisterMacEHPort();

        [PreserveSig]
        new HRESULT SetStartupFlags(
