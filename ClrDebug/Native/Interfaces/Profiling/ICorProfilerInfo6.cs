...
{
    /// <summary>
    /// [Supported in the .NET Framework 4.6 and later versions] A subclass of <see cref="ICorProfilerInfo5"/> that provides an enumerator for all methods that are defined in a given NGen module and inline a given method.
    /// </summary>
...
#endif
    public partial interface ICorProfilerInfo6 : ICorProfilerInfo5
    {
#if !GENERATED_MARSHALLING
        /// <summary>
