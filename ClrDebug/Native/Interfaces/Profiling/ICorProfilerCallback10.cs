...
{
    /// <summary>
    /// A subclass of <see cref="ICorProfilerCallback9"/> that provides callback methods to notify the profiler that EventPipe events have been delivered to the profiler's currently active session.
    /// </summary>
...
#endif
    public unsafe partial interface ICorProfilerCallback10 : ICorProfilerCallback9
    {
#if !GENERATED_MARSHALLING
        /// <summary>
