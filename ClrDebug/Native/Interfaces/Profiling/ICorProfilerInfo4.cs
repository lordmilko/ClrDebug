...
namespace ClrDebug
{
    ...
    /// . The ICorProfilerInfo4 interface is an extension of the other ICorProfilerInfo interfaces. It provides new methods to support just-in-time (JIT) recompilation, added in .NET Framework 4.5.
    /// </summary>
    /// <remarks>
    /// The CLR implements the methods of the ICorProfilerInfo4 interface by using the free-threaded model. Each method
...
#endif
    public partial interface ICorProfilerInfo4 : ICorProfilerInfo3
    {
#if !GENERATED_MARSHALLING
        /// <summary>
