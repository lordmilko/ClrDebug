...
namespace ClrDebug.DIA
{
    ...
    public partial interface IDiaEnumSectionContribs
    {
        ...
        /// </summary>
        /// <param name="index">[in] Index of the <see cref="IDiaSectionContrib"/> object to be retrieved. The index is in the range 0 to count-1, where count is returned by the <see cref="get_Count"/> method.</param>
        /// <param name="section">[out] Returns an <see cref="IDiaSectionContrib"/> object representing the desired section contribution.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        HRESULT Item(
            [In] int index,
        ...
        /// <param name="rgelt">[out] An array that is to be filled with the <see cref="IDiaSectionContrib"/> objects that represent the desired section contributions.</param>
        ...
        /// </summary>
        /// <param name="ppenum">[out] Returns an <see cref="IDiaEnumSectionContribs"/> object that contains a duplicate of the enumerator. The section contributions are not duplicated, only the enumerator.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        HRESULT Clone(
