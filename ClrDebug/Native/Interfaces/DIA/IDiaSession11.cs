...
namespace ClrDebug.DIA
{
    ...
    [Guid("348368D5-5646-4B63-9F42-667FBFBA05E0")]
#if !GENERATED_MARSHALLING
    [ComImport]
#else
    [GeneratedComInterface]
#endif
    public partial interface IDiaSession11 : IDiaSession
    {
#if !GENERATED_MARSHALLING
        /// <summary>
        ...
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        new HRESULT findLinesByLinenum(
            [MarshalAs(UnmanagedType.Interface), In] IDiaSymbol compiland,
            [MarshalAs(UnmanagedType.Interface), In] IDiaSourceFile file,
            [In] int linenum,
            [In] int column,
        ...
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        new HRESULT findInjectedSource(
        ...
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        new HRESULT getEnumDebugStreams(
        ...
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        new HRESULT findInlineeLinesByLinenum(
            [MarshalAs(UnmanagedType.Interface), In] IDiaSymbol compiland,
            [MarshalAs(UnmanagedType.Interface), In] IDiaSourceFile file,
            [In] int linenum,
            [In] int column,
        ...
        [PreserveSig]
        new HRESULT findAcceleratorInlineeLinesByLinenum(
            [MarshalAs(UnmanagedType.Interface), In] IDiaSymbol parent,
            [MarshalAs(UnmanagedType.Interface), In] IDiaSourceFile file,
            [In] int linenum,
            [In] int column,
        ...
        [PreserveSig]
        new HRESULT addressForRVA(
            [In] int rva,
            [Out] out int pISect,
            [Out] out int pOffset);

        [PreserveSig]
        new HRESULT findILOffsetsByAddr(
            [In] int isect,
            [In] int offset,
            [In] int length,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumLineNumbers ppResult);
        ...
        [PreserveSig]
        new HRESULT findILOffsetsByRVA(
            [In] int rva,
            [In] int length,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumLineNumbers ppResult);

        [PreserveSig]
        new HRESULT findILOffsetsByVA(
            [In] long va,
            [In] int length,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumLineNumbers ppResult);

        [PreserveSig]
        new HRESULT findInputAssemblyFiles(
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumInputAssemblyFiles ppResult);

        [PreserveSig]
        new HRESULT findInputAssembly(
            [In] int index,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaInputAssemblyFile ppResult);

        [PreserveSig]
        new HRESULT findInputAssemblyById(
            [In] int uniqueId,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaInputAssemblyFile ppResult);

        [PreserveSig]
        new HRESULT getFuncMDTokenMapSize(
            [Out] out int pcb);

        [PreserveSig]
        new HRESULT getFuncMDTokenMap(
            [In] int cb,
            [Out] out int pcb,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U1, SizeParamIndex = 0)] byte[] pb);

        [PreserveSig]
        new HRESULT getTypeMDTokenMapSize(
            [Out] out int pcb);

        [PreserveSig]
        new HRESULT getTypeMDTokenMap(
            [In] int cb,
            [Out] out int pcb,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U1, SizeParamIndex = 0)] byte[] pb);

        [PreserveSig]
        new HRESULT getNumberOfFunctionFragments_VA(
            [In] long vaFunc,
            [In] int cbFunc,
            [Out] out int pNumFragments);

        [PreserveSig]
        new HRESULT getNumberOfFunctionFragments_RVA(
            [In] int rvaFunc,
            [In] int cbFunc,
            [Out] out int pNumFragments);

        [PreserveSig]
        new HRESULT getFunctionFragments_VA(
            [In] long vaFunc,
            [In] int cbFunc,
            [In] int cFragments,
        ...
        [PreserveSig]
        new HRESULT getFunctionFragments_RVA(
            [In] int rvaFunc,
            [In] int cbFunc,
            [In] int cFragments,
        ...
        [PreserveSig]
        new HRESULT getExports(
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumSymbols ppResult);

        [PreserveSig]
        new HRESULT getHeapAllocationSites(
            [Out, MarshalAs(UnmanagedType.Interface)] out IDiaEnumSymbols ppResult);
