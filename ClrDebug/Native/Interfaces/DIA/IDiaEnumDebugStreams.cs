...
namespace ClrDebug.DIA
{
    ...
    /// </summary>
    /// <remarks>
    /// The content of debug streams is implementation-dependent and the data formats are undocumented. Call the <see cref="IDiaSession.getEnumDebugStreams"/>
    ...
    public partial interface IDiaEnumDebugStreams
    {
        ...
        /// </summary>
        /// <param name="index">[in] Index or name of the debug stream to be retrieved. If an integer variant is used, it must be in the range 0 to count-1, where count is as returned by the <see cref="get_Count"/> method.</param>
        /// <param name="stream">[out] Returns an <see cref="IDiaEnumDebugStreamData"/> object representing the specified debug stream.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        HRESULT Item(
#if !GENERATED_MARSHALLING
        ...
        /// <param name="rgelt">[out] Returns an array of <see cref="IDiaEnumDebugStreamData"/> objects that represents the debug streams being retrieved.</param>
        ...
        /// </summary>
        /// <param name="ppenum">[out] Returns an <see cref="IDiaEnumDebugStreams"/> object that contains a duplicate of the enumerator. The streams are not duplicated, only the enumerator.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        [PreserveSig]
        HRESULT Clone(
