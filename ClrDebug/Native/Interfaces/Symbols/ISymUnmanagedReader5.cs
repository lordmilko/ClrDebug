...
#endif
    public partial interface ISymUnmanagedReader5 : ISymUnmanagedReader4
    {
#if !GENERATED_MARSHALLING
        /// <summary>
        ...
        /// <returns>S_OK if the method succeeds; otherwise, E_FAIL or some other error code.</returns>
        [PreserveSig]
        new HRESULT GetMethodByVersionPreRemap(
            [In] mdMethodDef token,
            [In] int version,
            [Out, MarshalAs(UnmanagedType.Interface)] out ISymUnmanagedMethod pRetVal);
        ...
        /// <returns>S_OK if the method succeeds; otherwise, E_FAIL or some other error code.</returns>
        [PreserveSig]
        new HRESULT GetSymAttributePreRemap(
            [In] mdToken parent,
            [In, MarshalAs(UnmanagedType.LPWStr)] string name,
            [In] int cBuffer,
            [Out] out int pcBuffer,
        ...
        /// <returns>S_OK if the method succeeds; otherwise, E_FAIL or some other error code.</returns>
        [PreserveSig]
        new HRESULT GetMethodsInDocument(
            [MarshalAs(UnmanagedType.Interface), In] ISymUnmanagedDocument document,
            [In] int cMethod,
            [Out] out int pcMethod,
        ...
        /// </summary>
        [PreserveSig]
        new HRESULT GetSymAttributeByVersion(
        ...
        /// </summary>
        [PreserveSig]
        new HRESULT GetSymAttributeByVersionPreRemap(
            [In] mdToken methodToken,
            [In] int version,
            [MarshalAs(UnmanagedType.LPWStr), In] string name,
            [In] int bufferLength,
        ...
        /// </summary>
        /// <param name="metadata">A pointer to memory where Portable Debug Metadata start. The memory is owned by the SymReader and
        ...
        [PreserveSig]
        new HRESULT GetPortableDebugMetadata(
        ...
        /// </summary>
        /// <param name="data">A pointer to memory where Source Server data start. The memory is owned by the SymReader and
        /// valid until <see cref="ISymUnmanagedDispose.Destroy"/> is invoked.
        ///
        ...
        /// The native diasymreader may implement <see cref="GetSourceServerData(out IntPtr, out int)"/> by simply calling
        /// to <see cref="M:ISymUnmanagedSourceServerModule.GetSourceServerData"/>.
        /// </remarks>
        [PreserveSig]
        new HRESULT GetSourceServerData(
            [Out] out IntPtr data,
            [Out] out int size);
#endif
