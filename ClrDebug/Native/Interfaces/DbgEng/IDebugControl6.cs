...
namespace ClrDebug.DbgEng
{
    ...
    public interface IDebugControl6 : IDebugControl5
    {
        ...
        /// language, see the processor documentation. The disassembly options--returned by <see cref="IDebugControl3.GetAssemblyOptions"/>--affect
        ...
        /// each supports a different syntax. The current expression evaluator can be chosen by using <see cref="IDebugControl3.SetExpressionSyntax"/>.
        ...
        /// <returns>This method can also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// GetLogFile and GetLogFileWide behave the same way as <see cref="GetLogFile2"/> and GetLogFile2Wide with Append
        /// receiving only the information about the DEBUG_LOG_APPEND flag. For more information about log files, see Using
        /// Input and Output.
        /// </remarks>
        [PreserveSig]
        new HRESULT GetLogFileWide(
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT ControlledOutputWide(
            [In] DEBUG_OUTCTL OutputControl,
            [In] DEBUG_OUTPUT Mask,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Format);
        ...
        [PreserveSig]
        [Obsolete("This method cannot be safely called from managed code")]
        new HRESULT ControlledOutputVaListWide(
            [In] DEBUG_OUTCTL OutputControl,
            [In] DEBUG_OUTPUT Mask,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Format,
            [In] IntPtr va_list_Args);
        ...
        /// OutputPrompt and OutputPromptWide can be used to prompt the user for input. The standard prompt will be sent to
        /// the output callbacks before the formatted text described by Format. The contents of the standard prompt is returned
        /// by the method <see cref="IDebugControl.GetPromptText"/>. The prompt text is sent to the output callbacks with the
        /// DEBUG_OUTPUT_PROMPT output mask set. For more information about prompting the user, see Using Input and Output.
        /// </remarks>
        [PreserveSig]
        new HRESULT OutputPromptWide(
            [In] DEBUG_OUTCTL OutputControl,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Format);
        ...
        /// OutputPromptVaList and OutputPromptVaListWide can be used to prompt the user for input. The standard prompt will
        /// be sent to the output callbacks before the formatted text described by Format. The contents of the standard prompt
        /// is returned by the method <see cref="IDebugControl.GetPromptText"/>. The prompt text is sent to the output callbacks
        /// with the DEBUG_OUTPUT_PROMPT output mask set. For more information about prompting the user, see Using Input and
        /// Output.
        /// </remarks>
        [PreserveSig]
        [Obsolete("This method cannot be safely called from managed code")]
        new HRESULT OutputPromptVaListWide(
            [In] DEBUG_OUTCTL OutputControl,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Format,
            [In] IntPtr va_list_Args);

        /// <summary>
        /// The GetPromptTextWide method returns the standard prompt text that will be prepended to the formatted output specified in the OutputPrompt and <see cref="IDebugControl.OutputPromptVaList"/> methods.
        /// </summary>
        /// <param name="Buffer">[out, optional] Receives the prompt text. If Buffer is NULL, this information is not returned.</param>
        /// <param name="BufferSize">[in] Specifies the size, in characters, of the Buffer buffer.</param>
        /// <param name="TextSize">[out, optional] Receives the size, in characters, of the prompt text. If TextSize is NULL, this information is not returned.</param>
        ...
        /// </summary>
        /// <param name="Offset">[in] Specifies the location in the target's memory to place the assembled instruction.</param>
        /// <param name="Instr">[in] Specifies the instruction to assemble. The instruction is assembled according to the target's effective processor type (returned by <see cref="IDebugControl.SetEffectiveProcessorType"/>).</param>
        /// <param name="EndOffset">[out] Receives the location in the target's memory immediately following the assembled instruction. EndOffset can be used when assembling multiple instructions.</param>
        /// <returns>This method can also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// The assembly language depends on the effective processor type of the target machine. For information about the
        ...
        /// </summary>
        /// <param name="Type">[in] Specifies the type of the processor whose name is requested. See <see cref="IDebugControl.GetActualProcessorType"/> for a list of possible values.</param>
        /// <param name="FullNameBuffer">[out, optional] Receives the full name of the processor type. If FullNameBuffer is NULL, this information is not returned.</param>
        /// <param name="FullNameBufferSize">[in] Specifies the size, in characters, of the buffer that FullNameBuffer specifies. This size includes the space for the '\0' terminating character.</param>
        /// <param name="FullNameSize">[out, optional] Receives the size in characters of the full name of the processor type. This size includes the space for the '\0' terminating character.<para/>
        /// If FullNameSize is NULL, this information is not returned.</param>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetProcessorTypeNamesWide(
            [In] IMAGE_FILE_MACHINE Type,
        ...
        /// <param name="CommandFile">[in] Specifies the name of the file that contains the commands to execute. This file is opened for reading and its contents are interpreted as if they had been typed into the debugger console.</param>
        /// <param name="Flags">[in] Specifies execution options for the command. The default options are to log the command but not to send it to the output.<para/>
        /// For details about the values that Flags can take, see <see cref="IDebugControl.Execute"/>.</param>
        /// <returns>This method might also return error values, including error values caused by a failure to open the specified file.<para/>
        /// For more information, see Return Values.</returns>
        /// <remarks>
        /// This method reads the specified file and execute the commands one line at a time using <see cref="IDebugControl.Execute"/>.
        /// If an exception occurred while executing a line, the execution will continue with the next line.
        /// </remarks>
        [PreserveSig]
        new HRESULT ExecuteCommandFileWide(
            [In] DEBUG_OUTCTL OutputControl,
        ...
        /// </summary>
        /// <param name="Index">[in] Specifies the zero-based index of the breakpoint to return. This is specific to the current process. The value of Index should be between zero and the total number of breakpoints minus one.<para/>
        /// The total number of breakpoints can be determined by calling <see cref="IDebugControl.GetNumberBreakpoints"/>.</param>
        /// <param name="bp">[out] Receives the returned breakpoint.</param>
        /// <returns>This method can also return other error values. See Return Values for more details.</returns>
        /// <remarks>
        /// The index and returned breakpoint are specific to the current process. The same index will return a different breakpoint
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetBreakpointByIndex2(
            [In] int Index,
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetBreakpointById2(
            [In] int Id,
            [Out, ComAliasName("IDebugBreakpoint2")] out IntPtr bp);
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetExtensionByPathWide(
            [In, MarshalAs(UnmanagedType.LPWStr)] string Path,
            [Out] out long Handle);
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetExtensionFunctionWide(
            [In] long Handle,
        ...
        /// </summary>
        /// <param name="Index">[in] Specifies the index of the event filter. Index can take any value between zero and one less than the total number of event filters returned by <see cref="IDebugControl.GetNumberEventFilters"/> (inclusive).<para/>
        /// For more information about the index of the filters, see Index and Exception Code.</param>
        /// <param name="Buffer">[out, optional] Receives the debugger command that the engine will execute when the event occurs.</param>
        /// <param name="BufferSize">[in] Specifies the size, in characters, of the buffer that Buffer specifies. This size includes the space for the '\0' terminating character.</param>
        /// <param name="CommandSize">[out, optional] Receives the size in characters of the command. This size includes the space for the '\0' terminating character.<para/>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetEventFilterCommandWide(
            [In] int Index,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 2)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int CommandSize);
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT SetEventFilterCommandWide(
            [In] int Index,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Command);

        [PreserveSig]
        new HRESULT GetSpecificEventFilterArgumentWide(
            [In] int Index,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 2)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int ArgumentSize);
        ...
        [PreserveSig]
        new HRESULT SetSpecificEventFilterArgumentWide(
            [In] int Index,
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetExceptionFilterSecondCommandWide(
            [In] int Index,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 2)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int CommandSize);
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT SetExceptionFilterSecondCommandWide(
            [In] int Index,
            [In, MarshalAs(UnmanagedType.LPWStr)] string Command);
        ...
        /// <param name="Type">[out] Receives the type of the last event generated by the target. For a list of possible types, see DEBUG_EVENT_XXX.</param>
        /// <param name="ProcessId">[out] Receives the process ID of the process in which the event occurred. If this information is not available, DEBUG_ANY_ID will be returned instead.</param>
        /// <param name="ThreadId">[out] Receives the thread ID of the thread in which the last event occurred. If this information is not available, DEBUG_ANY_ID will be returned instead.</param>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetLastEventInformationWide(
            [Out] out DEBUG_EVENT_TYPE Type,
            [Out] out int ProcessId,
            [Out] out int ThreadId,
            [Out, ComAliasName("IntPtr")] out DEBUG_LAST_EVENT_INFO ExtraInformation,
        ...
        /// Then, if no match is found, the automatic aliases are searched. If SrcText is NULL, Index is used to specify the alias.</param>
        /// <param name="Index">[in] Specifies the index of an alias. The indexes of the user-named aliases come before the indexes of the automatic aliases.<para/>
        /// Index is only used if SrcText is NULL. Index can be used along with <see cref="IDebugControl2.GetNumberTextReplacements"/> to iterate over all the user-named and automatic aliases.</param>
        /// <param name="SrcBuffer">[out, optional] Receives the name of the alias. This is the name specified in SrcText, if SrcText is not NULL. If SrcBuffer is NULL, this information is not returned.</param>
        /// <param name="SrcBufferSize">[in] Specifies the size, in characters, of the SrcBuffer buffer.</param>
        /// <param name="SrcSize">[out, optional] Receives the size, in characters, of the name of the alias. If SrcSize is NULL, this information is not returned.</param>
        /// <param name="DstBuffer">[out, optional] Receives the value of the alias specified by SrcText and Index. If DstBuffer is NULL, this information is not returned.</param>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetTextReplacementWide(
        ...
        /// Before executing commands or evaluating expressions, the debugger engine will replace the alias specified by SrcText
        /// with the value of the alias (specified by DstText). If SrcText is an asterisk (*) and DstText is NULL, all user-named
        /// aliases are removed. This is the same behavior as the <see cref="IDebugControl2.RemoveTextReplacements"/> method.
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT SetTextReplacementWide(
            [In, MarshalAs(UnmanagedType.LPWStr)] string SrcText,
        ...
        /// <remarks>
        /// The expression syntax is a global setting within the engine, so setting the expression syntax will affect all clients.
        /// The expression syntax of the engine determines how the engine will interpret expressions passed to <see cref="IDebugControl.Evaluate"/>,
        /// <see cref="IDebugControl.Execute"/>, and any other method that evaluates an expression. After the expression syntax
        /// has been changed, the engine sends out notification to the <see cref="IDebugEventCallbacks"/> callback object registered
        /// with each client. It also passes the DEBUG_CES_EXPRESSION_SYNTAX flag to the <see cref="IDebugEventCallbacks.ChangeEngineState"/>
        /// method.
        /// </remarks>
        [PreserveSig]
        new HRESULT SetExpressionSyntaxByNameWide(
        ...
        /// </summary>
        /// <param name="Index">[in] Specifies the index of the expression syntax. Index should be between zero and the number of expression syntaxes returned by <see cref="IDebugControl3.GetNumberExpressionSyntaxes"/> minus one.</param>
        /// <param name="FullNameBuffer">[out, optional] Receives the full name of the expression syntax. If FullNameBuffer is NULL, this information is not returned.</param>
        /// <param name="FullNameBufferSize">[in] Specifies the size, in characters, of the buffer FullNameBuffer. This size includes the space for the '\0' terminating character.</param>
        /// <param name="FullNameSize">[out, optional] Receives the size, in characters, of the full name of the expression syntax. This size includes the space for the '\0' terminating character.<para/>
        /// If FullNameSize is NULL, this information is not returned.</param>
        /// <param name="AbbrevNameBuffer">[out, optional] Receives the abbreviated name of the expression syntax. If AbbrevNameBuffer is NULL, this information is not returned.</param>
        /// <param name="AbbrevNameBufferSize">[in] Specifies the size, in characters, of the buffer AbbrevNameBufferSize. This size includes the space for the '\0' terminating character.</param>
        /// <param name="AbbrevNameSize">[out, optional] Receives the size, in characters, of the abbreviated name of the expression syntax. This size includes the space for the '\0' terminating character.<para/>
        /// If AbbrevNameSize is NULL, this information is not returned.</param>
        /// <returns>This method can also return error values. See Return Values for more details.</returns>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetExpressionSyntaxNamesWide(
            [In] int Index,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 2)] char[] FullNameBuffer,
            [In] int FullNameBufferSize,
            [Out] out int FullNameSize,
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetEventIndexDescriptionWide(
            [In] int Index,
            [In] DEBUG_EINDEX Which,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 3)] char[] Buffer,
            [In] int BufferSize,
        ...
        /// <param name="BufferSize">[in] Specifies the size, in characters, of the Buffer buffer.</param>
        /// <param name="FileSize">[out, optional] Receives the size, in characters, of the name of the log file. If FileSize is NULL, this information is not returned.</param>
        /// <param name="Flags">[out] Receives the bit-flags that were used when opening the log file. See the Flags parameter of <see cref="OpenLogFile2"/> for a description of these flags.</param>
        /// <returns>This method can also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// For more information about log files, see Using Input and Output.
        /// </remarks>
        [PreserveSig]
        new HRESULT GetLogFile2(
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U1, SizeParamIndex = 1)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int FileSize,
        ...
        /// </summary>
        /// <param name="PlatformId">[out] Receives the platform ID. PlatformId is always VER_PLATFORM_WIN32_NT for NT-based Windows.</param>
        /// <param name="Win32Major">[out] Receives the major version number of the target's operating system. For Windows 2000, Windows XP, and Windows Server 2003, this number is 5.<para/>
        /// For Windows Vista, Windows 7, and Windows 8, this number is 6.</param>
        /// <param name="Win32Minor">[out] Receives the minor version number for the target's operating system. For Windows 2000 this is 0; for Windows XP, 1; for Windows Server 2003, 2.<para/>
        /// For Windows Vista, this is 0; for Windows 7, 1; for Windows 8, 2.</param>
        /// <param name="KdMajor">[out, optional] Receives 0xF if the target's operating system is a free build, and 0xC if it is a checked build.</param>
        /// <param name="KdMinor">[out, optional] Receives the build number for the target's operating system.</param>
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// For more information, see Target Information.
        /// </remarks>
        [PreserveSig]
        new HRESULT GetSystemVersionValues(
            [Out] out int PlatformId,
        ...
        /// <param name="Buffer">[out, optional] Receives the version string. If Buffer is NULL, this information is not returned.</param>
        /// <param name="BufferSize">[in] Specifies the size, in characters, of the buffer that Buffer specifies. This size includes the space for the '\0' terminating character.</param>
        /// <param name="StringSize">[out, optional] Receives the size, in characters, of the string that identifies the build. This size includes the space for the '\0' terminating character.<para/>
        /// If SizeString is NULL, this information is not returned.</param>
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// For more information, see Target Information.
        /// </remarks>
        [PreserveSig]
        new HRESULT GetSystemVersionString(
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetSystemVersionStringWide(
            [In] DEBUG_SYSVERSTR Which,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 2)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int StringSize);
        ...
        /// <param name="Frames">[out, optional] Receives the stack frames. The number of elements this array holds is FrameSize. If Frames is NULL, this information is not returned.</param>
        ...
        /// <param name="FramesFilled">[out, optional] Receives the number of frames that were placed in the array Frames and contexts in FrameContexts.<para/>
        /// If FramesFilled is NULL, this information is not returned.</param>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetContextStackTrace(
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT OutputContextStackTrace(
            [In] DEBUG_OUTCTL OutputControl,
            [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DEBUG_STACK_FRAME[] Frames,
            [In] int FramesSize,
            [In] IntPtr FrameContexts,
        ...
        /// </summary>
        /// <param name="Type">[out] Receives the type of the stored event. For a list of possible types, see DEBUG_EVENT_XXX.</param>
        /// <param name="ProcessId">[out] Receives the process ID of the process in which the event occurred. If this information is not available, DEBUG_ANY_ID will be returned instead.</param>
        /// <param name="ThreadId">[out] Receives the thread ID of the thread in which the last event occurred. If this information is not available, DEBUG_ANY_ID will be returned instead.</param>
        ...
        /// <param name="ContextUsed">[out, optional] Receives the size in bytes of the context. If ContextUsed is NULL, this information is not returned.</param>
        /// <param name="ExtraInformation">[out, optional] Receives extra information about the event. The contents of this extra information depends on the type of the event.<para/>
        /// If ExtraInformation is NULL, this information is not returned.</param>
        /// <param name="ExtraInformationSize">[in] Specifies the size, in bytes, of the buffer that ExtraInformation specifies.</param>
        /// <param name="ExtraInformationUsed">[out, optional] Receives the size in bytes of extra information. If ExtraInformationUsed is NULL, this information is not returned.</param>
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetStoredEventInformation(
            [Out] out DEBUG_EVENT_TYPE Type,
            [Out] out int ProcessId,
            [Out] out int ThreadId,
            [In] IntPtr Context,
        ...
        /// <param name="String">[out] A pointer to a string from the debugging APIs.</param>
        /// <param name="StringSize">[in] The size of the string.</param>
        /// <param name="StringNeeded">[out, optional] A pointer to an output string.</param>
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        [PreserveSig]
        new HRESULT GetManagedStatus(
        ...
        /// <param name="Flags">[out, optional] A pointer to flags from the debugging APIs.</param>
        /// <param name="WhichString">[in] A value that controls which string to use.</param>
        /// <param name="String">[out] A pointer to a Unicode character string from the debugging APIs.</param>
        /// <param name="StringSize">[in] The size of the string.</param>
        /// <param name="StringNeeded">[out, optional] A pointer to an output string.</param>
        ...
        [PreserveSig]
        new HRESULT GetManagedStatusWide(
            [Out] out DEBUG_MANAGED Flags,
            [In] DEBUG_MANSTR WhichString,
        ...
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        [PreserveSig]
        new HRESULT ResetManagedStatus(
