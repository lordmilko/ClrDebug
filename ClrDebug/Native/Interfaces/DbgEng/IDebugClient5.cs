...
namespace ClrDebug.DbgEng
{
    ...
    public interface IDebugClient5 : IDebugClient4
    {
        ...
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// The DEBUG_DUMP_XXX constants are used by the methods WriteDumpFile, <see cref="WriteDumpFile2"/>, and <see cref="WriteDumpFileWide"/>
        ...
        /// to include in the file, use <see cref="WriteDumpFile2"/> or <see cref="WriteDumpFileWide"/>. For more information
        /// about crash dump files, see Dump-File Targets. Moreover, the following aliases are available for kernel-mode debugging.
        /// Additionally, the following aliases are available for user-mode debugging. For a description of kernel-mode dump
        /// files, see Varieties of Kernel-Mode Dump Files. For a description of user-mode dump files, see Varieties of User-Mode
        /// Dump Files.
        /// </remarks>
        [PreserveSig]
        ...
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        /// <remarks>
        /// The DEBUG_FORMAT_XXX bit-flags are used by WriteDumpFile2 and <see cref="WriteDumpFileWide"/> to determine the
        /// format of a crash dump file and, for user-mode Minidumps, what information to include in the file. The following
        /// bit-flags apply to all crash dump files. The following bit-flags can also be included for user-mode Minidumps.
        ...
        /// that of <see cref="CreateProcessAndAttach2"/> when its argument ProcessId is set to zero. For more information
