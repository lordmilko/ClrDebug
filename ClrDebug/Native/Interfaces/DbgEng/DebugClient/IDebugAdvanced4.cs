...
namespace ClrDebug.DbgEng
{
    ...
    public interface IDebugAdvanced4 : IDebugAdvanced3
    {
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT GetSourceFileInformationWide(
            [In] DEBUG_SRCFILE Which,
        ...
        /// </remarks>
        [PreserveSig]
        new HRESULT FindSourceFileAndTokenWide(
            [In] int StartElement,
            [In] long ModAddr,
            ...
            [In] int FileTokenSize,
            [Out] out int FoundElement,
            [SRI.Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeParamIndex = 8)] char[] Buffer,
            [In] int BufferSize,
            [Out] out int FoundSize);
        ...
        /// <returns>This method may also return error values. See Return Values for more details.</returns>
        [PreserveSig]
        new HRESULT GetSymbolInformationWide(
            [In] DEBUG_SYMINFO Which,
            [In] long Arg64,
            [In] int Arg32,
            [Out] IntPtr Buffer,
