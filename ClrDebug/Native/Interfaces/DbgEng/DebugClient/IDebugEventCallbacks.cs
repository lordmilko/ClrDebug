...
namespace ClrDebug.DbgEng
{
    ...
    {
        /// <summary>
        /// The GetInterestMask callback method is called to determine which events the IDebugEventCallbacks object is interested in.<para/>
        ...
        /// the engine, and--if the breakpoint is a private breakpoint--this <see cref="IDebugEventCallbacks"/> object was
        /// registered with the client that added the breakpoint. The engine calls this method only if the DEBUG_EVENT_BREAKPOINT
        ...
        /// the value of Bp might be invalid after Breakpoint returns. Therefore, implementations of IDebugEventCallbacks should
        /// not access Bp after Breakpoint returns. For more information about handling events, see Monitoring Events. For
        /// information about managing breakpoints, see Breakpoints.
        /// </remarks>
        [PreserveSig]
        ...
        /// implementations of IDebugEventCallbacks should not access this structure after returning. For more information
        ...
        /// For more information, see Breakpoints. The value of Argument is the code interpretation level. The value of Argument is the execution status (as described in the DEBUG_STATUS_XXX topic) possibly combined with the bit flag DEBUG_STATUS_INSIDE_WAIT.<para/>
        /// DEBUG_STATUS_INSIDE_WAIT is set when a WaitForEvent call is pending. For more information, see Debugging Session and Execution Model.<para/>
