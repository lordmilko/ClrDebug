...
{
    /// <summary>
    /// The expression evaluator interface to the underlying debugger. This version 2 of the interface supports all of the previous methods with identical signatures and includes additional new methods that provide added functionality.<para/>
...
#endif
    public partial interface IDebugHostEvaluator2 : IDebugHostEvaluator
    {
#if !GENERATED_MARSHALLING
        /// <summary>
