...
{
    /// <summary>
    /// An optional interface on scripts (objects which implement <see cref="IDataModelScript"/>). If this interface is supported, the script provider has a debug engine capable of some limited form of 'script debugging'.<para/>
    /// This may include stepping, setting breakpoints, inspecting data, etc... This version 2 of the interface supports all of the previous methods with identical signatures and includes additional new methods that provide added functionality.<para/>
    ...
    public interface IDataModelScriptDebug2 : IDataModelScriptDebug
    {
        ...
        /// <param name="breakpoint">The newly created breakpoint will be returned here.</param>
        /// <returns>This method returns HRESULT that indicates success or failure.</returns>
        [PreserveSig]
