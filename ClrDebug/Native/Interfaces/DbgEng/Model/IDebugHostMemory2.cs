...
{
    /// <summary>
    /// The memory access interface to the underlying debugger. This version 2 of the interface supports all of the previous methods with identical signatures and includes additional new methods that provide added functionality.<para/>
...
#endif
    public partial interface IDebugHostMemory2 : IDebugHostMemory
    {
#if !GENERATED_MARSHALLING
        /// <summary>
